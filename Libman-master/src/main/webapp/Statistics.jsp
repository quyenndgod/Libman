  ...
  <body>
    ...
    <div class="container">
      <div class="statistics-menu">
        ...
        <div class="menu-item">
          <a href="reader" class="menu-btn">Thống kê độc giả</a>
        </div>
        <div class="menu-item">
          <a href="#" class="menu-btn">Thống kê tài liệu</a>
        </div>
        <div class="menu-item">
          <a href="#" class="menu-btn">Thống kê nhà cung cấp</a>
        </div>

        <a href="MainManagementStaff.jsp" class="back-btn">Quay lại</a>
      </div>
    </div>
